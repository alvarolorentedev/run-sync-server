...
describe('Test the endomondo endpoit', () => {
    ...
    test('endomondo login is called with correct parameters', async () => {
        ...
        var result = await request.post('/endomondo/login').send({email: randomEmail, password: randomPassword})
    ...
    test('endomondo login returns error if empty request', async () => {
        ...
        var result = await request.post('/endomondo/login').send()
    ...
    test('endomondo get list of workouts with correct parameters', async () => {
        ...
        var result = await request.get('/endomondo/workouts').send({authToken: randomToken})
    ...
    test('endomondo get list of workouts returns error if empty request', async () => {
        var result = await request.get('/endomondo/workouts').send()
        expect(result.statusCode).toBe(400)
    })
    ...
    test('endomondo post calls workouts with correct parameters', async () => {
        var randomToken = Math.random().toString(36).substr(0, 5)
        var randomUserId = Math.random().toString(36).substr(0, 5)
        var randomDuration = Math.random()
        var randomTime = Math.random()
        var result = await request.post('/endomondo/workouts').send([{authToken: randomToken, userId : randomUserId, duration: randomDuration , time : randomTime}])
    ...
    test('endomondo post calls without authToken', async () => {
        var randomToken = Math.random().toString(36).substr(0, 5)
        var result = await request.post('/endomondo/workouts').send([{userId: "pepe", duration: 10, time : 10}])
        expect(result.statusCode).toBe(400)
    })

    test('endomondo post calls without userId', async () => {
        var result = await request.post('/endomondo/workouts').send([{authToken: "pepe", duration: 10, time : 10}])
        expect(result.statusCode).toBe(400)
    })

    test('endomondo post calls without duration', async () => {
        var result = await request.post('/endomondo/workouts').send([{authToken: "pepe", userId: "pepe", time : 10}])
        expect(result.statusCode).toBe(400)
    })

    test('endomondo post calls without time', async () => {
        var result = await request.post('/endomondo/workouts').send([{authToken: "pepe", userId: "pepe" , duration: 10}])
        expect(result.statusCode).toBe(400)
    })
})